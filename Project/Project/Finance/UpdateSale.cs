    ...
    public partial class UpdateSale : Form
    {
            ...
            using (SqlCommand command = new SqlCommand(query, con))
            {
                using (SqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        string data7 = reader["Customercompany"].ToString();
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("Update Sale set Product=@Product,Count=@Count,Unitprice=@Unitprice,Totalprice=@Totalprice,Movementlocation=@Movementlocation," +
                    "Arrivallocation=@Arrivallocation,Customercompany=@Customercompany,Companynumber=@Companynumber,Transportername=@Transportername,Transporternumber=@Transporternumber," +
                ...
                cmd.Parameters.AddWithValue("@Customercompany", companyTb.Text);
                ...
                MessageBox.Show("The Sale Updated", "SUCCES", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            if (companyTb.Text == "Customer Company")
            {
                companyTb.Text = "";
            }
        }
