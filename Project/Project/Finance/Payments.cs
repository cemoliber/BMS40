    ...
    public partial class Payments : Form
    {
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("insert into Payments values (@Paymentinstitution,@Amountpaid,@Billtype,@Paymentmethod,@Paymentdate,@Paiddate)", con);
        ...
        private void paymentInstitutionTb_Enter(object sender, EventArgs e)
        {
            if (paymentInstitutionTb.Text == "Payment Institution")
            {
                paymentInstitutionTb.Text = "";
            }
        }

        private void amountPaidTb_Enter(object sender, EventArgs e)
        {
            if (amountPaidTb.Text == "Amount Paid")
            {
                amountPaidTb.Text = "";
            }
        }

        private void paymentInstitutionTb_Leave(object sender, EventArgs e)
        {
            if (paymentInstitutionTb.Text == "")
            {
                paymentInstitutionTb.Text = "Payment Institution";
            }
        }

        private void amountPaidTb_Leave(object sender, EventArgs e)
        {
            if (amountPaidTb.Text == "")
            {
                amountPaidTb.Text = "Amount Paid";
            }
        }
    }
}
